...
function VideoCard({ type, data }) {
    ...
    const { videoCardLoader, setVideoCardLoader } = useLoader()
    ...
    return (
        <div className=' h-full w-full'>
            {
                videoCardLoader ? <VideoCardSkeleton />
                    :
                    <div className=' rounded-lg p-1 relative'>
                        ...
                        <div className=' grid grid-cols-[45px_auto] mt-2 items-center gap-1'>
                            ...
                            <section >
                                <p className=' text-xs dark:text-white text-black'>{videoData?.title}</p>
                                <p className=' text-xs text-gray-400'>{channelData?.name}</p>
                                <section className=' mt-1 text-gray-500 flex text-[10px] justify-between items-center w-[full]'>
